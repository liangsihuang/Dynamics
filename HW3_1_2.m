...
M1=M(1,1);
c1=z(1)*2*M1*wn(1);
[y11,v11,a11]=NewmarkMethod(1/2,1/4,p1,t_aim,K1,M1,c1,0.01);
% 第二振型方程求解
p2=P(2,1)*sin(2*pi*i);
K2=K(2,2);
M2=M(2,2);
c2=z(2)*2*M2*wn(2);
[y12,v12,a12]=NewmarkMethod(1/2,1/4,p2,t_aim,K2,M2,c2,0.01);
% 第三振型方程求解
p3=P(3,1)*sin(2*pi*i);
K3=K(3,3);
M3=M(3,3);
c3=z(3)*2*M3*wn(3);
[y13,v13,a13]=NewmarkMethod(1/2,1/4,p3,t_aim,K3,M3,c3,0.01);
...
M1=M(1,1);
c1=z(1)*2*M1*wn(1);
[y11,v11,a11]=WilsonTheta(p1,t_aim,K1,M1,c1,0.01);
% 第二振型方程求解
p2=P(2,1)*sin(2*pi*i);
K2=K(2,2);
M2=M(2,2);
c2=z(2)*2*M2*wn(2);
[y12,v12,a12]=WilsonTheta(p2,t_aim,K2,M2,c2,0.01);
% 第三振型方程求解
p3=P(3,1)*sin(2*pi*i);
K3=K(3,3);
M3=M(3,3);
c3=z(3)*2*M3*wn(3);
[y13,v13,a13]=WilsonTheta(p2,t_aim,K3,M3,c3,0.01);
